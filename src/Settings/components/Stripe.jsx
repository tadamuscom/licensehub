			...
			<>
				<FormGroup>
					<CheckBox
						...
						value={lchb_settings.stripe_integration === 'true'}
						wrapperOnClick={onClick}
					/>
				</FormGroup>
				<div
					className={
						lchb_settings.stripe_integration === 'true' ? '' : 'tada-hidden'
					}
					...
					<FormGroup>
						...
						<Input
							...
							value={
								lchb_settings.stripe_public_key
									? lchb_settings.stripe_public_key
									: ''
							}
						/>
					...
					<FormGroup>
						...
						<Input
							...
							value={
								lchb_settings.stripe_private_key
									? lchb_settings.stripe_private_key
									: ''
							}
						/>
