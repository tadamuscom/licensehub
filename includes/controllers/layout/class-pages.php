...
if ( ! class_exists( 'Pages' ) ) {
	/**
	 * Handle all the dashboard pages
	 */
	class Pages {
		/**
		 * Construct the class
		...
		public function products_callback(): void {
			...
			wp_enqueue_script(
				'lchb-products-page',
				LCHB_PAGE . '/products/build/index.js',
				array(
					'wp-i18n',
					'wp-element',
					'wp-api-fetch',
		...
		public function license_keys_callback(): void {
			...
			wp_enqueue_script(
				...
				LCHB_PAGE . '/license_keys/build/index.js',
				array(
					'wp-i18n',
					'wp-element',
					'wp-api-fetch',
		...
		public function api_keys_callback(): void {
			...
			wp_enqueue_script(
				'lchb-api-keys-page',
				LCHB_PAGE . '/api_keys/build/index.js',
				array(
					'wp-i18n',
					'wp-element',
					'wp-api-fetch',
		...
		public function settings_callback(): void {
			...
			wp_enqueue_script(
				'lchb-settings-page',
				LCHB_PAGE . '/settings/build/index.js',
				array(
					'wp-i18n',
					'wp-element',
					'wp-api-fetch',
