...
function Stripe(props) {
    ...
    if( lchb_settings.stripe_integration === 'true' ) {
        return (
            <>
                <FormGroup>
                    <CheckBox label='Stripe Integration' id='tada-stripe-integration' name='tada-stripe-integration' value={(lchb_settings.stripe_integration === 'true')} wrapperOnClick={onClick}/>
                </FormGroup>
